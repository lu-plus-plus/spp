...
namespace spp {
	...
	#define user_defined_literal(ret_type, suffix, literal_type) inline __host__ __device__ ret_type operator "" _ ## suffix(literal_type literal) { return static_cast<ret_type>(literal); }
